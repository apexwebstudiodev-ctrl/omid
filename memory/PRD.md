...
- ToolkitSection (2026-08-21): replaced "Trusted by bold brands" strip. 5 AI-generated photorealistic 3D renders (gpt-image-1, quality high, via EMERGENT_LLM_KEY): keyboard, mouse, headphones, chrome sphere, glass torus — dark metallic + purple/magenta rim light, pure black crushed, shown with mix-blend-screen over per-layer #0C0C0C backdrops (transformed ancestors isolate blending). Cursor parallax (spring depth layers) + container rotateX/rotateY tilt + idle float loops. Generator script: /app/backend/gen_toolkit.py
